        ...
        >
          {stackIndices.map((tIndex, pos) => {
            ...
            return (
              <div
                key={tIndex}
                className={`absolute left-1/2 h-120 max-w-[100vh] sm:h-96.5  ${testimonial.color} text-left w-[98vw]  sm:w-198 sm:p-10 py-10 px-4 space-y-10 rounded-[54px] shadow-[0_-6px_10px_rgba(0,0,0,0.2)]`}
                style={cardStyle}
              >
                <svg
                  width="64"
