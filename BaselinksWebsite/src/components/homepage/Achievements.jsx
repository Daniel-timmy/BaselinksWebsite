...
const Achievements = () => {
  return (
    <div className="flex max-lg:flex-col lg:p-8 p-4 lg:min-w-7/10 lg:justify-between sm:items-end space-y-25">
      <div className="flex flex-col items-start space-y-8 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:hover:w-300 lg:w-full justify-items-center sm:justify-items-end">
        <div
          style={{
