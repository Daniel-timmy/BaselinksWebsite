...
const Principles = () => {
  return (
    <div className="flex flex-col items-center space-y-20 w-screen py-10 bg-card-principle">
      <div className="flex relative justify-center items-center size-86 sm:size-111 text-black">
      ...
      <div className="sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-10 sm:space-y-5">
