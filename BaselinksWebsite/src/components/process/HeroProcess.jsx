...
const Hero = () => {
  return (
    <div className="mt-36 px-4 space-y-6 w-screen flex flex-col items-center justify-center">
      ...
      <p className="text-[16px]/5 text-hero-text lg:text-[20px]/6 sm:w-161 text-center">
